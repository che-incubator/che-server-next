...
#   IMAGE_REGISTRY_HOST     - Container registry host (default: quay.io)
#   IMAGE_REGISTRY_USER_NAME - Registry username/namespace (default: oorel)
...
if [ -n "$1" ]; then
    ...
    REGISTRY_HOST="${IMAGE_REGISTRY_HOST:-quay.io}"
    REGISTRY_USER="${IMAGE_REGISTRY_USER_NAME:-oorel}"
